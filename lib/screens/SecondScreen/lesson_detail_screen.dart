...
class _LessonDetailScreenState extends State<LessonDetailScreen> {
  ...
  void _initializeYouTubePlayer() {
    try {
      // ✅ استخدام الحقول المناسبة من هيكل Firebase الجديد
      String? videoUrl = widget.lesson['video_url'] ?? '';
      ...
      child: Column(
        ...
        children: [
          ...
          _buildInfoRow(
            ...
            iconColor: isActive ? Color(0xFF10B981) : Color(0xFFEF4444),
          ),
          SizedBox(height: 12.h),
          ...
          onPressed: () {
            showDialog(
              ...
              builder: (context) => Directionality(
                textDirection: TextDirection.rtl,
                child: AlertDialog(
                  title: Text('معلومات الدرس', style: TextStyle(fontFamily: 'Tajawal')),
                  content: Column(
                    mainAxisSize: MainAxisSize.min,
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      Text('المادة: ${widget.subjectName}', style: TextStyle(fontFamily: 'Tajawal')),
                      Text('الكورس ID: ${widget.courseId}', style: TextStyle(fontFamily: 'Tajawal')),
                      Text('الدرس ID: ${widget.lesson['id'] ?? 'غير معروف'}', style: TextStyle(fontFamily: 'Tajawal')),
                    ],
                  ),
                  actions: [
                    TextButton(
