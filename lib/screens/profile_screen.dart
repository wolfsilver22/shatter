...
class _ProfileScreenState extends State<ProfileScreen> with TickerProviderStateMixin {
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              _buildSubscriptionDetail('رقم الحساب', authService.studentNumber ?? ''),
              _buildSubscriptionDetail('الصف المختار', authService.selectedGrade ?? 'لم يتم الاختيار'),
              _buildSubscriptionDetail('حالة الحساب', 'نشط'),
                  ...
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      children: [
                        ...
                        _buildStatsSection(),
                        _buildSubscriptionCard(authService),
                        _buildMenuSection(),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        userData?['email'] ?? authService.studentNumber ?? 'رقم الحساب',
                        style: TextStyle(
                          fontSize: 14.sp,
                          color: Colors.white.withOpacity(0.9),
                          fontFamily: 'Tajawal',
                      ...
                      Row(
                        children: [
                          ...
                          SizedBox(width: 4.w),
                          Text(
                            'الصف: ${authService.selectedGrade ?? "لم يتم الاختيار"}',
                            style: TextStyle(
                              fontSize: 12.sp,
                              color: Colors.white.withOpacity(0.8),
                              fontFamily: 'Tajawal',
                      ...
                      Row(
                        children: [
                          ...
                          SizedBox(width: 4.w),
                          Text(
                            'حساب ${userData?['is_active'] == true ? 'نشط' : 'غير نشط'}',
                            style: TextStyle(
                              fontSize: 12.sp,
                              color: Colors.white.withOpacity(0.8),
                              fontFamily: 'Tajawal',
  ...
  Widget _buildSubscriptionCard(AuthService authService) {
    return SlideTransition(
      position: Tween<Offset>(
        begin: const Offset(0, 0.3),
        end: Offset.zero,
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      ...
                      Text(
                        'رقم الحساب: ${authService.studentNumber}',
                        style: TextStyle(
                          fontSize: 12.sp,
                          color: Colors.white.withOpacity(0.9),
                          fontFamily: 'Tajawal',
