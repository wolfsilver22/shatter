            ...
            slivers: [
              SliverAppBar(
                ...
                flexibleSpace: FlexibleSpaceBar(
                  ...
                  // تم إزالة النص "المواد الدراسية" من هنا
                  title: null,
                ),
              ),
        ...
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(
                  'المواد الدراسية', // تم نقل النص إلى هنا
                  style: TextStyle(
                    fontSize: 14.sp,
                    fontWeight: FontWeight.bold,
                    color: _textPrimary,
      ...
      child: Container(
        decoration: BoxDecoration(
          gradient: LinearGradient(
            ...
            colors: [
              _primaryBlue,
              Color(0xFF1565C0), // لون أزرق أغمق قليلاً للتدرج
            ],
          ),
          borderRadius: BorderRadius.circular(12.r),
        ),
          ...
          child: Column(
            ...
            children: [
              ...
              Container(
                padding: EdgeInsets.all(12.w),
                decoration: BoxDecoration(
                  color: _primaryBlue, // خلفية زرقاء للعنوان
                ...
                child: Text(
                  ...
                  style: TextStyle(
                    fontSize: 14.sp,
                    fontWeight: FontWeight.bold,
                    color: Colors.white, // لون أبيض للعنوان
                    fontFamily: 'Tajawal',
                  ),
                  textAlign: TextAlign.center,
                  maxLines: 2,
