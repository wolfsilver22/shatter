...
class _HomeScreenState extends State<HomeScreen> with TickerProviderStateMixin {
  ...
  // ✅ تحديث الألوان لتتناسب مع الخلفية المتحركة
  final Color _primaryBlue = const Color(0xFF1E88E5);
  final Color _secondaryColor = Colors.transparent; // أصبحت شفافة
  final Color _accentColor = const Color(0xFFFFA726);
  ...
  final Color _errorRed = const Color(0xFFEF4444);
  final Color _warningOrange = const Color(0xFFFFA726);
  final Color _glassEffect = Colors.white.withOpacity(0.85);
    ...
    showDialog(
      ...
      builder: (context) => Dialog(
        ...
        child: Directionality(
          ...
          child: Stack(
            children: [
              // ✅ تحديث الخلفية لتتناسب مع التصميم الجديد
              Container(
                padding: EdgeInsets.all(28.w),
                margin: EdgeInsets.only(top: 50.h),
                decoration: BoxDecoration(
  ...
  void _showErrorDialog(String title, String message, IconData icon, Color iconColor) {
    showDialog(
      context: context,
      barrierColor: Colors.black54,
      builder: (context) => Dialog(
