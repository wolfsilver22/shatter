                ...
                child: Dialog(
                  ...
                  child: Container(
                    ...
                    child: Column(
                      mainAxisSize: MainAxisSize.min,
                      children: [
                        // الجزء العلوي مع الرموز المتحركة
                        Expanded(
                          flex: 2,
                          child: Stack(
                        ...
                        // الجزء السفلي مع المعلومات والأزرار
                        Expanded(
                          flex: 1,
                          child: Container(
                            width: double.infinity,
                            ...
                            child: Column(
                              ...
                              children: [
                                Text(
                                  'نحن سعداء بانضمامك إلى منصة مودي للتعلم',
                                  style: TextStyle(
                                    fontSize: 16,
                                    color: _inactiveColor,
                                    fontFamily: 'Tajawal',
                                ...
                                Text(
                                  'ابدأ رحلتك التعليمية الآن واستكشف جميع الميزات المتاحة',
                                  style: TextStyle(
                                    fontSize: 14,
                                    color: _inactiveColor.withOpacity(0.8),
                                    fontFamily: 'Tajawal',
                                    height: 1.4,
                                  ),
                                  textAlign: TextAlign.center,
                                    ...
                                    Expanded(
                                      child: ElevatedButton(
                                        onPressed: () {
                                          Navigator.of(context).pop();
                                          _isInitialized = true;
                                          _onItemTapped(3); // الانتقال لشاشة الحساب
                                        },
                                        style: ElevatedButton.styleFrom(
                                          backgroundColor: _activeColor,
                                          foregroundColor: Colors.white,
