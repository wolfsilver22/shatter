                    ...
                    child: Column(
                      children: [
                        ...
                        _buildInfoRow(
                          ...
                          title: 'حالة الحساب',
                          value:
                              authService.isAccountActive() ? 'نشط' : 'غير نشط',
                          iconColor:
              ...
              child: BottomNavigationBar(
                ...
                items: [
                  BottomNavigationBarItem(
                    ...
                    activeIcon: Icon(Iconsax.home_1, size: 24.sp),
                    label: 'الرئيسية',
                  ),
                  BottomNavigationBarItem(
                    icon: Icon(Iconsax.activity, size: 24.sp),
                    activeIcon: Icon(Iconsax.activity, size: 24.sp),
                    label: 'النشاطات',
                  ),
                  BottomNavigationBarItem(
                    icon: Icon(Iconsax.book_1, size: 24.sp),
                    activeIcon: Icon(Iconsax.book_1, size: 24.sp),
                    label: 'المكتبة',
                  ),
                  BottomNavigationBarItem(
                    icon: Icon(Iconsax.profile_circle, size: 24.sp),
                    activeIcon: Icon(Iconsax.profile_circle, size: 24.sp),
                    label: 'حسابي',
                  ),
                ],
              ),
