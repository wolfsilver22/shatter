                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: Column(
                          children: [
                            Text(
                              'نحن سعداء بانضمامك إلى عائلة مودي',
                              style: TextStyle(
                                fontSize: 16.sp,
                                color: _inactiveColor,
                                fontFamily: 'Tajawal',
                            ...
                            Text(
                              'يمكنك الآن استكشاف جميع الميزات والبدء في رحلتك التعليمية',
                              style: TextStyle(
                                fontSize: 14.sp,
                    ...
                    child: Column(
                      children: [
                        ...
                        _buildInfoRow(
                          ...
                          title: 'حالة الحساب',
                          value: authService.isAccountActive() ? 'نشط' : 'غير مفعل',
                          iconColor: authService.isAccountActive() ? Color(0xFF10B981) : Color(0xFFEF4444),
                        ),
                      ],
                    ),
                  ),
