...
class _MainNavigationState extends State<MainNavigation> {
  ...
  // 🎨 Palette Colors (Matching the Design Image)
  final Color _primaryBlue = const Color(0xFF3C6FEF); // Royal Blue
  final Color _orangeAccent = const Color(0xFFFDB933); // Secondary Accent
  final Color _bgOffWhite = const Color(0xFFF8F9FD); // Background
  final Color _inactiveGrey = const Color(0xFF9CA3AF); // Inactive Text/Icon
  ...
  void _showSessionExpiredDialog() {
    showDialog(
      ...
      builder: (context) => Directionality(
        textDirection: TextDirection.rtl,
        child: AlertDialog(
          title: Text('انتهت الجلسة', style: TextStyle(fontFamily: 'Tajawal', fontWeight: FontWeight.bold)),
          content: Text('يرجى تسجيل الدخول مرة أخرى.', style: TextStyle(fontFamily: 'Tajawal')),
          actions: [
            TextButton(
              onPressed: () => Navigator.of(context).popUntil((route) => route.isFirst),
              child: Text('موافق', style: TextStyle(fontFamily: 'Tajawal', color: _primaryBlue)),
            ),
          ],
        ),
      ),
    ...
    return Consumer<AuthService>(
      builder: (context, authService, child) {
        ...
        return IndexedStack(
          index: _currentIndex,
          children: [
            HomeScreen(navigateToLessons: navigateToLessons), // Index 0
            HomeworkSolverScreen(), // Index 1
  ...
  Widget build(BuildContext context) {
    return Directionality(
      ...
      child: Scaffold(
        backgroundColor: _bgOffWhite,
        extendBody: true, // ✅ يسمح للمحتوى بالظهور خلف الناف بار المنحني

        // 1️⃣ الشاشات
        body: _buildCurrentScreen(),

        // 2️⃣ الزر العائم في المنتصف (كاميرا / مسح)
        floatingActionButton: FloatingActionButton(
          onPressed: () {
            // يمكن توجيهه لفتح الكاميرا أو صفحة "حل الواجب" مباشرة
            _onItemTapped(1);
          },
          backgroundColor: _primaryBlue,
          elevation: 4,
          shape: const CircleBorder(),
          child: Icon(Iconsax.scan_barcode, color: Colors.white, size: 28.sp),
        ),
        floatingActionButtonLocation: FloatingActionButtonLocation.centerDocked,

        // 3️⃣ شريط التنقل السفلي المخصص
        bottomNavigationBar: BottomAppBar(
          shape: const CircularNotchedRectangle(), // ✅ الانحناء تحت الزر العائم
          notchMargin: 8.0, // المسافة بين الزر والشريط
          color: Colors.white,
          elevation: 10,
          ...
          child: Container(
            ...
            child: Row(
              ...
              children: [
                ...
                Row(
                  children: [
                    _buildNavItem(0, Iconsax.home_1, Iconsax.home, 'الرئيسية'),
                    SizedBox(width: 20.w),
                    _buildNavItem(1, Iconsax.magic_star, Iconsax.magic_star, 'النشاطات'),
                  ],
                ),

                // مسافة فارغة في المنتصف للزر العائم
                SizedBox(width: 40.w),

                // الجزء الأيسر
                Row(
                  children: [
                    _buildNavItem(2, Iconsax.book_1, Iconsax.book, 'المكتبة'),
                    SizedBox(width: 20.w),
                    _buildNavItem(3, Iconsax.profile_circle, Iconsax.profile_circle, 'حسابي'),
                  ],
                ),
              ],
            ),
          ...
          children: [
            AnimatedContainer(
              ...
              child: Icon(
                ...
                size: 24.sp,
                color: isSelected ? _primaryBlue : _inactiveGrey,
              ),
            ),
            SizedBox(height: 4.h),
            Text(
